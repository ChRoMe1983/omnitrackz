defmodule OmnitracksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OmnitracksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OmnitracksWeb.Gettext, "errors", msg, opts)
    end
  end
